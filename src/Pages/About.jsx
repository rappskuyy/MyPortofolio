        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            >
              ...
              >
                Raffasya Javas Niscala Widjaja
              </span>
            </h2>
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
           Seorang Front-End Developer yang saat ini bersekolah di SMK Wikrama Bogor kelas 10. Saya memiliki minat besar dalam pengembangan web, khususnya dalam membangun tampilan yang modern, responsif, dan mudah digunakan. Saya senang mengeksplorasi teknologi baru, belajar secara mandiri, serta mengembangkan berbagai proyek untuk meningkatkan kemampuan saya di dunia pemrograman.
            </p>
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Barangsiapa yang bersungguh-sungguh, maka ia akan berhasil"
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1Cd2etuTmk2jeAAKOx0n7fQfkFJ0cyn0l/view?usp=sharing" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
